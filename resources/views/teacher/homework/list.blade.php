      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right">
            <a href="{{url('teacher/homework/home_work/add')}}" class="btn btn-primary">Add New Homework</a>
          </div>
        </div>
      </div>
    </section>
                  ...
                  <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <a href="{{url('teacher/homework/home_work')}}" class="btn btn-success" style="margin-top:30px">Reset</a>
                            </div>
                        </div>
                  </div>
                </form>
                  ...
                  <tbody>
                    @forelse ($getRecord as $value)
                        <tr>
                            ...
                            <td>
                                <a href="{{url('teacher/homework/home_work/edit/' .$value->id)}}" class="btn btn-primary">Edit</a>
                                <a href="{{url('teacher/homework/home_work/delete/' .$value->id)}}" class="btn btn-danger">Delete</a>
                                <a href="{{url('teacher/homework/home_work/submitted/' .$value->id)}}" class="btn btn-success">Submitted Homework</a>
                            </td>

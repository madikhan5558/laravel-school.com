...
<div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Student Submitted Homework <span class="text-primary">( {{ $getStudent->name }} {{ $getStudent->last_name }} )</span></h1>
          </div>
        </div>
      </div>
    </section>
                  ...
                  <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <a href="{{url('parent/my_student/submitted_homework/'.$getStudent->id)}}" class="btn btn-success">Reset</a>
                            </div>
                        </div>
                  </div>
                </form>

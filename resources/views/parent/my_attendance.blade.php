    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>My Attendance <span class="text-primary">({{$getStudent->name}} {{$getStudent->last_name}}) (Total : {{$getRecord->total()}})</h1>
                    </div>
                </div>
            </div>
        </section>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3 col-lg-2 mt-4 pt-2">
                                            <button class="btn btn-primary" type="submit"
                                                >Search</button>
                                            <a href="{{ url('parent/my_student/attendance/'.$getStudent->id) }}" class="btn btn-success">Reset</a>
                                        </div>
                                    </div>
                                </div>
                            </form>

...
class StudentAddFeesModel extends Model
{
    ...
    {
        $return = self::select('student_add_fees.*', 'class.name as class_name', 'users.name as created_name', 'student.name as student_first_name', 'student.last_name as student_last_name')
